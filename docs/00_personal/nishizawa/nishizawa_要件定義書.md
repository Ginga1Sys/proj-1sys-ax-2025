...
- **目的（プロジェクトで達成すること／成功指標）**：
  ...
  - 成功指標（例）：
    - DAU（Daily Active Users）= 50〜100、最終目標 600
...
- **同時接続数**：同時アクセス数が100件を超えても安定して動作すること。
...
- **主要画面の要件**：ナレッジ詳細に本文、タグ、添付、いいね、コメント、編集履歴
